...
Pod::Spec.new do |s|
  ...
  s.name         = "RGScrollLayoutCache"
  s.version      = "1.0.2"
  s.summary      = "Pre-load layout of UITableView or UICollectionView in background thread"
  ...
  s.homepage     = "https://github.com/RengeRenge/RGScrollLayoutCache.git"
  ...
  s.source       = { :git => "https://github.com/RengeRenge/RGScrollLayoutCache.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "RGScrollLayoutCache", "RGScrollLayoutCache/**/*.{h,m}"
